...
exports.decorateConfig = (config) => {
    ...
    const iconsColoredCSS = `
        ...
        .tab_process.process_yarn:before, .tab_process.process_php:before {
...
const getIcon = (title) => {
    const process = filter(['shell', 'gulp', 'php', 'node', 'npm', 'yarn', 'vim', 'nvim'], title.split(' ')[1] ? title.split(' ')[1] : title, { maxResults: 1 });

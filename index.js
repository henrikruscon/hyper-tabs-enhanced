...
exports.decorateConfig = (config) => {
    ...
    const trafficButtonsCSS = `
        ...
        .t_nav:hover .t_minimize {
            background-color: #FFC130;
        }
        .t_nav:hover .t_maximize {
    ...
    const trafficButtonsBorderCSS = `
        ...
        .r_tab.r_active:first-of-type {
            border-left-color: transparent !important;
        }
        .r_tab.r_active:first-of-type:before {
            left: -1px;
        }
    `
    const borderCSS = `
    ...
    `
    const pulseCSS = `
        .r_tab.r_hasActivity .r_text {
            animation: pulse 3s ease-in-out infinite;
        }
        .r_tab.r_hasActivity:hover .r_text {
            animation: none;
        }
        @keyframes pulse {
            0% {
    ...
    const iconsCSS = `
        ...
        .r_process.process_shell:before {
            left: 6px;
        ...
        .r_process.process_vim:before, .r_process.process_nvim:before {
            left: 2px;
        ...
        .r_process.process_python:before {
            left: 1px;
        ...
        .r_process.process_mysql:before {
        ...
        .v_title .r_process:before, .r_tab.r_active .r_process:before, .r_tab:hover .r_process:before {
            background-color: ${isDark ? 'white' : config.foregroundColor};
        }
        .r_tab.r_hasActivity .r_process:before {
            background-color: ${hyperTabs.activityColor} !important;
        }
    `
    const iconsColoredCSS = `
        .r_process:not(.process_shell):before {
            transition: none;
        }
        .r_process.process_gulp:before, .r_process.process_npm:before {
            background-color: ${config.colors.red} !important;
        }
        .r_process.process_yarn:before, .r_process.process_php:before, .r_process.process_mysql:before {
            background-color: ${config.colors.blue} !important;
        }
        .r_process.process_node:before, .r_process.process_vim:before, .r_process.process_nvim:before {
    ...
    return Object.assign({}, config, {
        css: `
            ...
            .r_tab.r_hasActivity .r_icon:before, .r_tab.r_hasActivity .r_icon:hover {
                background-color: ${hyperTabs.activityColor};
            }
            .r_tab.r_hasActivity .r_icon:hover:before {
        ...
        render() {
            return (
                React.createElement(Hyper, Object.assign({}, this.props, {
                    customChildren: React.createElement('nav', { className: 't_nav' },
                        React.createElement('div', { className: 't_action t_close', onClick: this.closeApp }),
                        React.createElement('div', { className: 't_action t_minimize', onClick: this.minimizeApp }),
                        React.createElement('div', { className: 't_action t_maximize', onClick: this.maximizeApp })
                    )
                }))
            )
        }
...
exports.decorateTab = (Tab, { React }) => {
    return class extends Tab {
        render() {
            ...
            this.props.text = React.createElement('span', { title: this.props.text, className: `r_process process_${icon}` }, this.props.text);
    ...
    return class extends Tabs {
        render() {
            if (this.props.tabs.length === 1 && typeof this.props.tabs[0].title === 'string') {
                ...
                this.props.tabs[0].title = React.createElement('span', { title: this.props.tabs[0].title, className: `r_process process_${icon}` }, this.props.tabs[0].title);
            }
